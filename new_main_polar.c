...
int main(int argc, char ** argv)
{
    ...
    */
    ...
    double norm_sigma = dplasma_dlange( dague, PlasmaFrobeniusNorm,
                                       (tiled_matrix_desc_t*)&descA );
    printf("\n norm_sigma %2.10e \n", norm_sigma);
   /*
    ...
    */
    ...
    two_dim_block_cyclic_t descT1, descT2;
    ...
    dplasma_dorgqr( dague,
                    (tiled_matrix_desc_t*)&descH, 
                    (tiled_matrix_desc_t*)&descT1, (tiled_matrix_desc_t*)&descQ1 );
    ...
    dplasma_dorgqr( dague,
                    (tiled_matrix_desc_t*)&descU, 
                    (tiled_matrix_desc_t*)&descT2, (tiled_matrix_desc_t*)&descQ2 );
    ...
    if ( rank == 0 ) {
        fprintf(stderr,
                ...
                "# dplasma QDWH \n"
                "#\n"
                "# \tN  \t#itQR  \t#itPO  \tGflop/s \tMB   \tNB   \tIB   \tSMB   \tSNB   \tP   \tQ   \tTime    \tBerr  \t\tOrth   \n"
                "   %6d \t%4d  \t%4d  \t%8.2f \t%4d \t%3d \t%3d \t%3d \t%3d \t%3d \t%3d \t%e \t%e \t%e\n"
                "/////////////////////////////////////////////////////////////////////////\n",
                M, itQR, itPO, flops/1e9/sync_time_elapsed, MB, NB, IB, SMB, SNB, P, Q, sync_time_elapsed, berr/Anorm, orth/Anorm);
    }
